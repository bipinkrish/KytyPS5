...
void WindowContext::CreateVulkan() {
	...
	// TEMP-DIAG-SYNCVAL: synchronization validation names missing
	// barrier/semaphore hazards (WRITE-after-READ across submits) that present
	// as device hangs. Active whenever validation layers are on.
